...
path_man_player_animations = "C:/Users/Admin/PycharmProjects/Pokemon/men/"
...
def redrawGameWindow():
    global steps
    player_right = [pygame.image.load(os.path.join(path_man_player_animations, "r1.png")),
                    pygame.image.load(os.path.join(path_man_player_animations, "r2.png")),
                    pygame.image.load(os.path.join(path_man_player_animations, "r3.png")),
                    pygame.image.load(os.path.join(path_man_player_animations, "r4.png"))]
    player_left = [pygame.image.load(os.path.join(path_man_player_animations, "l1.png")),
                   pygame.image.load(os.path.join(path_man_player_animations, "l2.png")),
                   pygame.image.load(os.path.join(path_man_player_animations, "l3.png")),
                   pygame.image.load(os.path.join(path_man_player_animations, "l4.png"))]
    player_up = [pygame.image.load(os.path.join(path_man_player_animations, "u1.png")),
                 pygame.image.load(os.path.join(path_man_player_animations, "u2.png")),
                 pygame.image.load(os.path.join(path_man_player_animations, "u3.png")),
                 pygame.image.load(os.path.join(path_man_player_animations, "u4.png"))]
    player_down = [pygame.image.load(os.path.join(path_man_player_animations, "d1.png")),
                   pygame.image.load(os.path.join(path_man_player_animations, "d2.png")),
                   pygame.image.load(os.path.join(path_man_player_animations, "d3.png")),
                   pygame.image.load(os.path.join(path_man_player_animations, "d4.png"))]
    player_stand = [pygame.image.load(os.path.join(path_man_player_animations, "d1.png"))]
...
pkm_caught = PokemonCaught(path_man_player_animations)
pkm_uncaught = PokemonUncaught(path_man_player_animations)
...
while True:
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_UP:
                ...
                if window_state == "menu":
                    player = Player(250, 275, path_man_player_animations)
                    ...
                    pokemon = Pokemon(1, path_pokemons, path_audio, path_moves_animations, path_exp_bar, path_hp_bar)
                    ...
                    pokemon = Pokemon(2, path_pokemons, path_audio, path_moves_animations, path_exp_bar, path_hp_bar)
                    player.pokemons.append(pokemon)
                    pokemon = Pokemon(3, path_pokemons, path_audio, path_moves_animations, path_exp_bar, path_hp_bar)
                    player.pokemons.append(pokemon)
                    pokemon = Pokemon(2, path_pokemons, path_audio, path_moves_animations, path_exp_bar, path_hp_bar)
                    player.pokemons.append(pokemon)
                    pokemon = Pokemon(1, path_pokemons, path_audio, path_moves_animations, path_exp_bar, path_hp_bar)
                    player.pokemons.append(pokemon)
                    pokemon = Pokemon(4, path_pokemons, path_audio, path_moves_animations, path_exp_bar, path_hp_bar)
                    player.pokemons.append(pokemon)
                ...
                if pokemon_exist and window_state == "encounter":
                    ...
                    elif use_bag_items_cursor.x == 245 and use_bag_items_cursor.y == 67 and len(player.pokemons) > 0:
                        selected_pkm = player.pokemons[0]
                        if selected_item.name == "Potion" or selected_item.name == "Super Potion" or selected_item.name == "Hyper Potion" or selected_item.name == "Max Potion":
                            if selected_pkm.current_hp != selected_pkm.hp:
                                selected_pkm.current_hp = selected_pkm.current_hp + selected_item.power
                                ...
                                window_state = "cannot_use_items"
                    elif use_bag_items_cursor.x == 245 and use_bag_items_cursor.y == 133 and len(player.pokemons) > 1:
                        selected_pkm = player.pokemons[1]
                        if selected_item.name == "Potion" or selected_item.name == "Super Potion" or selected_item.name == "Hyper Potion" or selected_item.name == "Max Potion":
                            if selected_pkm.current_hp != selected_pkm.hp:
                                selected_pkm.current_hp = selected_pkm.current_hp + selected_item.power
                                ...
                                window_state = "cannot_use_items"
                    elif use_bag_items_cursor.x == 245 and use_bag_items_cursor.y == 199 and len(player.pokemons) > 2:
                        selected_pkm = player.pokemons[2]
                        if selected_item.name == "Potion" or selected_item.name == "Super Potion" or selected_item.name == "Hyper Potion" or selected_item.name == "Max Potion":
                            if selected_pkm.current_hp != selected_pkm.hp:
                                selected_pkm.current_hp = selected_pkm.current_hp + selected_item.power
                                ...
                                window_state = "cannot_use_items"
                    elif use_bag_items_cursor.x == 245 and use_bag_items_cursor.y == 265 and len(player.pokemons) > 3:
                        selected_pkm = player.pokemons[3]
                        if selected_item.name == "Potion" or selected_item.name == "Super Potion" or selected_item.name == "Hyper Potion" or selected_item.name == "Max Potion":
                            if selected_pkm.current_hp != selected_pkm.hp:
                                selected_pkm.current_hp = selected_pkm.current_hp + selected_item.power
                                ...
                                window_state = "cannot_use_items"
                    elif use_bag_items_cursor.x == 245 and use_bag_items_cursor.y == 331 and len(player.pokemons) > 4:
                        selected_pkm = player.pokemons[4]
                        if selected_item.name == "Potion" or selected_item.name == "Super Potion" or selected_item.name == "Hyper Potion" or selected_item.name == "Max Potion":
                            if selected_pkm.current_hp != selected_pkm.hp:
                                selected_pkm.current_hp = selected_pkm.current_hp + selected_item.power
                    ...
                    if NPC_nurse.collide(player.shape):
                        ...
                        revive_effect = pygame.mixer.Sound(os.path.join(path_audio, 'revive_sound.wav'))
                        revive_effect.play()
                        player.main_pokemon[0].hp_bar_graphics = health_bar_status(player.main_pokemon[0].current_hp,
                        ...
                        if len(player.pokemons) == 1:
                            ...
                            player.pokemons[0].hp_bar_graphics = health_bar_status(player.pokemons[0].current_hp,
                                                                                   player.pokemons[0].hp, path_hp_bar)
                            ...
                            player.pokemons[1].hp_bar_graphics = health_bar_status(player.pokemons[1].current_hp,
                                                                                   player.pokemons[1].hp, path_hp_bar)
                            regen_pp(player.pokemons[0])
                            ...
                            player.pokemons[2].hp_bar_graphics = health_bar_status(player.pokemons[2].current_hp,
                                                                                   player.pokemons[2].hp, path_hp_bar)
                            regen_pp(player.pokemons[0])
                            regen_pp(player.pokemons[1])
                            ...
                            player.pokemons[3].hp_bar_graphics = health_bar_status(player.pokemons[3].current_hp,
                                                                                   player.pokemons[3].hp, path_hp_bar)
                            regen_pp(player.pokemons[0])
                            regen_pp(player.pokemons[1])
                            regen_pp(player.pokemons[2])
                            ...
                            player.pokemons[4].hp_bar_graphics = health_bar_status(player.pokemons[4].current_hp,
                                                                                   player.pokemons[4].hp, path_hp_bar)
                            regen_pp(player.pokemons[0])
                            regen_pp(player.pokemons[1])
                            regen_pp(player.pokemons[2])
                            regen_pp(player.pokemons[3])
                ...
                elif window_state == "pokemon_catching" and pokemon_catching_animation == len(pkm_caught.graphics_list):
                    window_state = "game"
                    pygame.mixer.music.load(os.path.join(path_audio, 'road.wav'))
                    pygame.mixer.music.play(-1)
                    up = False
    ...
    if window_state == "menu":
        ...
        catch_bg = BackgroundCatching(path_visual_elements)
        catch_bg.draw(screen)
        p_catch = PlayerCatching(path_man_player_animations)
        p_catch.draw(screen)
        battle_pkm = player.main_pokemon[0]
        pokemon.draw(398, 90)
        pokemon.draw_hp_bar(100, 112)
        ...
        battle_pkm.draw_battle()
        pokemon.draw(398, 90)
        type_text(str(leveling_pokemon.name) + " grew to LV. " + str(leveling_pokemon.level), 40, 350, 32, (255, 255, 255))
        if pokemon.current_hp > 0:
            pokemon.hp_bar_graphics = health_bar_status(pokemon.current_hp, pokemon.hp, path_hp_bar)
            pokemon.draw_hp_bar(100, 112)
        else:
        ...
        change_skill_bg.draw(screen)
        leveling_pokemon.draw(270, 130)
        type_text(str(leveling_pokemon.name) + " forgot " + str(move_to_change.name) + ".", 40, 350, 32, (255, 255, 255))
    elif window_state == "attack_learning_2_7":
        change_skill_bg.draw(screen)
        leveling_pokemon.draw(270, 130)
        ...
        change_skill_bg.draw(screen)
        leveling_pokemon.draw(270, 130)
        type_text(str(leveling_pokemon.name) + " learned " + str(learning_move.name) + ".", 40, 350, 32, (255, 255, 255))
    elif window_state == "stop_attack_learning":
        change_skill_bg.draw(screen)
        leveling_pokemon.draw(270, 130)
        ...
        cursor_bag.draw()
        if cursor_bag.y == 53 and window_state == "bag_items" and player.items[0].quantity != 0 and len(player.items) > 0:
            type_text(str(player.items[0].description[0:50]), 110, 355, 26, (255, 255, 255))
            type_text(str(player.items[0].description[50:len(player.items[0].description)]), 110, 390, 26, (255, 255, 255))
            player.items[0].draw()
            ...
            type_text(str(player.items[1].description[50:len(player.items[1].description)]), 110, 390, 26, (255, 255, 255))
            player.items[1].draw()
            ...
            type_text(str(player.items[2].description[50:len(player.items[2].description)]), 110, 390, 26, (255, 255, 255))
            player.items[2].draw()
            ...
            type_text(str(player.items[3].description[50:len(player.items[3].description)]), 110, 390, 26, (255, 255, 255))
            player.items[3].draw()
            ...
            type_text(str(player.items[4].description[50:len(player.items[3].description)]), 110, 390, 26, (255, 255, 255))
            player.items[4].draw()
        ...
        cursor_bag.draw()
        if len(player.key_items) > 0 and cursor_bag.y == 53 and window_state == "bag_key_items" and player.key_items[
            0].quantity != 0:
        ...
        elif len(player.key_items) > 1 and cursor_bag.y == 98 and window_state == "bag_key_items" and player.key_items[
            1].quantity != 0:
        ...
        elif len(player.key_items) > 2 and cursor_bag.y == 143 and window_state == "bag_key_items" and player.key_items[
            2].quantity != 0:
        ...
        elif len(player.key_items) > 3 and cursor_bag.y == 188 and window_state == "bag_key_items" and player.key_items[
            3].quantity != 0:
        ...
        elif len(player.key_items) > 4 and cursor_bag.y == 233 and window_state == "bag_key_items" and player.key_items[
            4].quantity != 0:
        ...
        cursor_bag.draw()
        if len(player.pokeballs) > 0 and cursor_bag.y == 53 and window_state == "bag_pokeballs" and player.pokeballs[
            0].quantity != 0:
        ...
        elif len(player.pokeballs) > 1 and cursor_bag.y == 98 and window_state == "bag_pokeballs" and player.pokeballs[
            1].quantity != 0:
        ...
        elif len(player.pokeballs) > 2 and cursor_bag.y == 143 and window_state == "bag_pokeballs" and player.pokeballs[
            2].quantity != 0:
        ...
        elif len(player.pokeballs) > 3 and cursor_bag.y == 188 and window_state == "bag_pokeballs" and player.pokeballs[
            3].quantity != 0:
        ...
        elif len(player.pokeballs) > 4 and cursor_bag.y == 233 and window_state == "bag_pokeballs" and player.pokeballs[
            4].quantity != 0:
        ...
        if len(player.main_pokemon) == 1:
            if pkm_menu_cursor.x == 8 and pkm_menu_cursor.y == 150 and selected_pkm == player.main_pokemon[0]:
                selection.graphics = pygame.image.load(os.path.join(path_visual_elements, "pokemon_menu_switch_1.png"))
                selection.x = 7
                selection.y = 75
                ...
                selection.graphics = pygame.image.load(os.path.join(path_visual_elements, "pokemon_menu_switch_1_2.png"))
                selection.x = 6
                selection.y = 80
            selection.draw()
            player.main_pokemon[0].draw_menu(40, 125)
        ...
        type_text("Met in " + str(selected_pkm.location) + " at Lv  " + str(selected_pkm.starting_level) + ".", 30, 370,
                  30, (0, 0, 0))
        ...
        if moves_cursor.y == 75 and len(selected_pkm.moves) >= 1:
            ...
            type_text(str(selected_pkm.moves[0].effect[50:len(selected_pkm.moves[0].effect)]), 24, 368, 25, (0, 0, 0))
            ...
            type_text(str(selected_pkm.moves[1].effect[50:len(selected_pkm.moves[1].effect)]), 24, 368, 25, (0, 0, 0))
            ...
            type_text(str(selected_pkm.moves[2].effect[50:len(selected_pkm.moves[2].effect)]), 24, 368, 25, (0, 0, 0))
            ...
            type_text(str(selected_pkm.moves[3].effect[50:len(selected_pkm.moves[3].effect)]), 24, 368, 25, (0, 0, 0))
        ...
        if cursor_bag.y == 53 and window_state == "selected_bag_items" and player.items[0].quantity != 0 and len(
            ...
            1].quantity != 0:
            player.items[1].draw()
        elif len(player.items) > 2 and cursor_bag.y == 143 and window_state == "selected_bag_items" and player.items[
            2].quantity != 0:
            player.items[2].draw()
        elif len(player.items) > 3 and cursor_bag.y == 188 and window_state == "selected_bag_items" and player.items[
            3].quantity != 0:
            player.items[3].draw()
        elif len(player.items) > 4 and cursor_bag.y == 233 and window_state == "selected_bag_items" and player.items[
            4].quantity != 0:
            player.items[4].draw()
        ...
        if cursor_bag.y == 53 and window_state == "toss_bag_items_1_2" and player.items[0].quantity != 0 and len(
            ...
            1].quantity != 0:
            player.items[1].draw()
        elif len(player.items) > 2 and cursor_bag.y == 143 and window_state == "toss_bag_items_1_2" and player.items[
            2].quantity != 0:
            player.items[2].draw()
        elif len(player.items) > 3 and cursor_bag.y == 188 and window_state == "toss_bag_items_1_2" and player.items[
            3].quantity != 0:
            player.items[3].draw()
        elif len(player.items) > 4 and cursor_bag.y == 233 and window_state == "toss_bag_items_1_2" and player.items[
            4].quantity != 0:
            player.items[4].draw()

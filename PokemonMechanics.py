...
def exp_bar_status(exp, to_next_level, path_exp_bar):
    ...
    elif round((exp / to_next_level) * 100) in range(100):
        exp_bar_graphics = pygame.image.load(os.path.join(path_exp_bar, "exp_bar_{}.png".format(100 - round((exp / to_next_level) * 100))))
    else:
